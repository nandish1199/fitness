...
import a1 from "./images/indi-products/tea/double1.jpg";
import b1 from "./images/indi-products/tea/double2.jpg";
import a2 from "./images/indi-products/tea/fresh1.jpg";
import b2 from "./images/indi-products/tea/fresh2.jpg";
import a3 from "./images/indi-products/tea/tata1.jpg";
import b3 from "./images/indi-products/tea/tata2.jpg";
import a4 from "./images/indi-products/tea/trusted1.jpg";
import b4 from "./images/indi-products/tea/trusted1.jpg";
import a5 from "./images/indi-products/tea/utsav1.jpg";
import b5 from "./images/indi-products/tea/utsav2.jpg";
const A2ghee = () => {
  const arr = [
    {
      name: "Double Diamond",
      price: 538,
      id: "details1",
      img1: "images/indi-products/tea/double1.jpg",
      img2: "images/indi-products/tea/double2.jpg",
    ...
    },
    {
      ...
      price: 251,
      id: "details2",
      img1: "images/indi-products/tea/fresh1.jpg",
      img2: "images/indi-products/tea/fresh2.jpg",
    ...
    },
    {
      ...
      price: 270,
      id: "details3",
      img1: "images/indi-products/tea/tata1.jpg",
      img2: "images/indi-products/tea/tata2.jpg",
      carddetailsrc: "#details3",
      buysrc: "https://www.amazon.in/Tata-Tea-Gold-500g/dp/B00GLDPBJK",
    },
    {
      name: "Trusted premium tea",
      price: 159,
      id: "details4",
      img1: "images/indi-products/tea/trusted1.jpg",
      img2: "images/indi-products/tea/trusted1.jpg",
      carddetailsrc: "#details4",
      buysrc:
        "https://www.amazon.in/Trusted-Value-Tea-Premium-Leaf/dp/B072FVZCNT",
    },
    {
      name: "Utsav",
      price: 159,
      id: "details5",
      img1: "images/indi-products/tea/utsav1.jpg",
      img2: "images/indi-products/tea/utsav2.jpg",
      carddetailsrc: "#details5",
      buysrc:
        "https://www.amazon.in/Goodricke-Utsav-CTC-Leaf-Tea/dp/B0858ZBGHB",
    },
  ];
  ...
  return (
    <container>
      <div className="row mx-auto">
        <h1 className="mainHead mb-3">Best Tea</h1>
        {arr.map((ele) => {
